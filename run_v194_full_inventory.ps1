...
Write-Host ""
Write-Host "Running MapleOCR v194 REAL run..."
Write-Host ""

python C:\MapleOCR\maple_batch_importer_easyocr_v194.py `
...
if ($LASTEXITCODE -ne 0) {
    ...
    Write-Host "Check C:\MapleOCR\Output_v194_check.zip for review details."
}
