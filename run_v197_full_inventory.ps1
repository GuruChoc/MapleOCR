...
Write-Host ""
Write-Host "Running MapleOCR v197 REAL run..."
Write-Host ""

python C:\MapleProjects\MapleOCR\maple_batch_importer_easyocr_v197.py `
...
if ($LASTEXITCODE -ne 0) {
    ...
    Write-Host "Check C:\MapleProjects\MapleOCR\Output_v197_check.zip for review details."
}
