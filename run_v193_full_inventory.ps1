...
Write-Host ""
Write-Host "Running MapleOCR v193 REAL run..."
Write-Host ""
...
if ($LASTEXITCODE -ne 0) {
    ...
    Write-Host "Check C:\MapleOCR\Output_v193_check.zip for review details."
}
